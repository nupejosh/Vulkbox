...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "nupejosh-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/vulkplayground"
  #   chef.validation_client_name = "vulkplayground-validator"
  #   chef.validation_key_path = ".chef/vulkplayground-validator.pem"
  # end
end
